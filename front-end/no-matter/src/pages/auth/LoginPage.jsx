...
function LoginPage() {
  ...
  const goKakao = (e) => {
    ...
    const url =
      "https://kauth.kakao.com/oauth/authorize?client_id=96b643173da8064d7b2774b812e747bb&redirect_uri=http://localhost:8080/login/oauth2/callback/kakao&response_type=code";
